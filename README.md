...
- **Modular Architecture**: Uses `src/main_loop.py` and modular core components. Automatically falls back to lite exchange/execution if `binance` library is missing.
